...
public class DesafioMeuTimeApplicationSimpleTest {
    ...
    public void deveBuscarJogadorMaisVelho(){
        final DesafioMeuTimeApplication desafioMeuTimeApplication = new DesafioMeuTimeApplication();
        desafioMeuTimeApplication.incluirTime(1l, "Teste1", LocalDate.now(), "branco", "branco");
        desafioMeuTimeApplication.incluirJogador(3l, 1l, "Jogador", LocalDate.now().minus(25, ChronoUnit.YEARS), 1, BigDecimal.TEN);
        desafioMeuTimeApplication.incluirJogador(2l, 1l, "Jogador2", LocalDate.now().minus(25, ChronoUnit.YEARS), 2, BigDecimal.TEN);
        assertEquals(3L, desafioMeuTimeApplication.buscarJogadorMaisVelho(1L).longValue());
    }
